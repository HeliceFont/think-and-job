...
export const HeaderText = forwardRef((props, ref) => {
    const {
        texts,
    ...
    return (
        <motion.span
            className={cn(defaultBaseStyles, mainClassName)}
            {...rest}
            layout
                ...
                >
                    {elements.map((wordObj, wordIndex, array) => {
                        ...
                        return (
                            <span 
                                key={wordIndex} 
                                className={cn(defaultSplitStyles, splitLevelClassName)}
                            >
                                {wordObj.characters.map((char, charIndex) => (
                                    <motion.span
                                        ...
                                        className={cn(defaultElementStyles, elementLevelClassName)}
                                    >
                                        {char}
                                    </motion.span>
                                ))}
