...
// Corregir la importación del SidebarCandidato
import { SidebarCandidato } from './SidebarCandidato'
...
export default function DashboardCandidato() {
    return (
        <div className="min-h-screen bg-gray-50">
            <Disclosure as="nav" className="bg-teal-900/75 fixed w-full backdrop-blur-md z-50">
            ...
            <main className="pt-28 px-2 sm:px-4 md:px-6 lg:px-8">
